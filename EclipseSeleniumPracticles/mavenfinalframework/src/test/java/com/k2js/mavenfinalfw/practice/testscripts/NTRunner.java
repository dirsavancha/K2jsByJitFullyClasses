...
public class NTRunner {
	...
	@Test(dataProvider = "ntt", dataProviderClass = ExcelReader.class, groups = {"medium" })
	public void verifyConformationMessage(String... data) {
		...
		try {
			...
			String expectedConfMessage=data[12];
			System.out.println("Expected Message : " + expectedConfMessage);
